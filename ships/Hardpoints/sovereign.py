...
# open_stbc extension: hull-conforming shield silhouette. Read by
# engine/shields.py at ship-load and passed through to renderer
# shield_pass.cc. Ignored by the original Appc.dll (NamedStub no-op).
